...
if ( is_admin() ) {
	...
	function anvato_load_dependencies() {
		require_once ANVATO_PATH . '/mexp/class-mexp-anvato-service.php';
		require_once ANVATO_PATH . '/mexp/class-mexp-anvato-template.php';
	}
	...
	add_action( 'load-settings_page_' . ANVATO_DOMAIN_SLUG, 'anvato_add_mexp_notice', 10 );
	/**
	...
	function anvato_mexp_nag() {        ?>
		<div class="update-nag">
			...
			<?php
				esc_html_e(
					'Even easier embedding, you can search for Anvato videos and add shortcodes directly from the Add Media screen 
					 by installing the Automattic Media Explorer plugin',
					'wp_anvato'
				);
			?>
			</p>
